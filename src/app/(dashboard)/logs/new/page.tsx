...
import type { AddLogState } from '../actions'

export default function NewLogPage() {
  const [state, formAction, isPending] = useActionState<AddLogState, FormData>(addLog, null)
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-semibold text-white">새 공부 기록</h1>
      </div>
        ...
        <form action={formAction} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              placeholder="오늘 공부한 내용의 제목을 입력하세요"
          ...
          <div>
            ...
            <input
              ...
              name="tags"
              type="text"
              placeholder="React, TypeScript, 알고리즘"
              className="w-full px-3.5 py-2.5 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
            />
          </div>
